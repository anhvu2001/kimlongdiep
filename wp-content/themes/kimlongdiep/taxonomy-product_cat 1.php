      ...
      <div class="product_category_header">
          ...
          switch ($slug) {
            ...
            case 'bong-tai':
              ...
              break;
            case 'hot-moissanite':
              $img_url = 'https://kimlongdiep.com/wp-content/uploads/2023/06/hotmoissanite.png';
            $alt='Hột moissanite';
              break;
            case 'mat-day-chuyen':
...
<script defer>
  document.addEventListener("DOMContentLoaded", function() {
    let fillters = '';
      ...
      getAndRender(8,null,fillters,0,0,<?php echo get_queried_object()->term_id; ?>,orderQuery);
  });
